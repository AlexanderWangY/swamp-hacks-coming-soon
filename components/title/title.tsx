const Title = () => {
  return (
    <div className='relative flex flex-col items-center justify-center'>
      <h1 className='z-2 sm:text-25xl absolute select-none bg-neutral-900 bg-clip-text text-17xl font-extrabold text-transparent drop-shadow-[0px_0px_3px_rgba(255,255,255,0.5)]'>
        X
      </h1>
